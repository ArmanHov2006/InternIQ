...
export function ApplicationDetailDialog({
  ...
  const stickyNoteClass = "space-y-2 rounded-md border border-amber-300 bg-amber-50 p-3";
  ...
  const updateApplicationByPatch = async (
      ...
      <DialogContent className="sm:max-w-[600px] w-full max-h-[90vh] overflow-y-auto">
        ...
        <div className="grid gap-4 py-2">
          ...
          <div className={stickyNoteClass}>
            <Label htmlFor="detail-notes" className="text-amber-800">
              Notes (Post-it)
            </Label>
            <Textarea
              id="detail-notes"
              ...
              className="border-amber-300 bg-amber-100/60 text-amber-950"
            />
          </div>

          {application.fit_score !== null || form.fit_analysis ? (
            <div className={stickyNoteClass}>
              <p className="text-sm font-medium text-amber-800">Saved Fit Analysis (Post-it)</p>
              {application.fit_score !== null ? (
                <p className="text-xs text-amber-700">Score: {application.fit_score}/100</p>
              ) : null}
              <Textarea
                rows={4}
            ...
            <details className="rounded-md border p-3" open>
              ...
              <div className="mt-3 space-y-2">
                <div className="flex flex-wrap gap-2">
                  ...
                  >
                    <IconFrame className="mr-2 h-6 w-6 rounded-md border-white/10 bg-white/[0.03] shadow-none">
